...
public class Baidu {
    public static void main(String[] args) throws IOException {
        ...
        channel.queueBind(RabbitmqConstant.QUEUE_BAIDU, RabbitmqConstant.EXCHANGE_WEATHER_ROUTING, "changsha");
        channel.queueBind(RabbitmqConstant.QUEUE_BAIDU, RabbitmqConstant.EXCHANGE_WEATHER_ROUTING, "wuhan");
