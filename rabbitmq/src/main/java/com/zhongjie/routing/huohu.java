...
public class huohu {
    public static void main(String[] args) throws IOException {
        ...
        channel.queueBind(RabbitmqConstant.QUEUE_HUOHU, RabbitmqConstant.EXCHANGE_WEATHER_ROUTING, "guangzhou");

        channel.queueBind(RabbitmqConstant.QUEUE_HUOHU, RabbitmqConstant.EXCHANGE_WEATHER_ROUTING, "huizhou");
